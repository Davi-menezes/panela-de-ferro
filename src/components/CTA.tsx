    ...
    <section className="py-28 px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-[#d4a853] text-sm font-semibold uppercase tracking-[0.2em] mb-5"
        >
        ...
        <motion.h2
          ...
          className="font-display text-5xl md:text-6xl font-black text-[#f7f5f0] leading-[1.08] mb-6"
        >
        ...
        <motion.p
          ...
          className="text-[#bda48f] text-lg leading-relaxed mb-10 max-w-xl mx-auto"
        >
        ...
        <motion.div
          ...
          className="flex flex-wrap justify-center gap-6 mb-10 text-sm text-[#8a7261]"
        >
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.97 }}
            className="inline-flex items-center gap-3 bg-gradient-to-r from-[#d4a853] via-[#e67e22] to-[#c05c30] text-[#0e0a07] font-black px-9 py-4.5 rounded-2xl text-base shadow-[0_0_40px_rgba(212,168,83,0.35)] border border-[#e9c46a]/30 transition-all duration-300"
          >
          ...
          <motion.a
            ...
            className="inline-flex items-center gap-2 text-[#bda48f] hover:text-[#e9c46a] font-semibold text-sm transition-colors duration-300"
          >
